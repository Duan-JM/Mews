...
15. A physical notch stays visually quiet while idle, uses aggregate red or green edge glows while collapsed, and preserves the existing expanded panel.
