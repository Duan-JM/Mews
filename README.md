...
- Uses a continuous black notch backing with green or red glow along its sides and bottom, carrying the effect onto the expanded panel, with Notification Center as the fallback.
